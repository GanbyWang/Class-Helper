...
public class StudyInfoActivity extends AppCompatActivity {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            // System.out.println("StudyInfoActivity: " + msg.obj.toString());
            ...
            switch (msg.what) {
                case HttpGet.GET_SUCC:
                    try {
                        ...
                        if(adapter==null){
                            adapter=new MyAdapter(StudyInfoActivity.this);
                        ...
                        e.printStackTrace();
                        System.out.println("StudyInfoActivity: JSON WRONG!!");
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public void showInfo(int position) {
            ...
            Intent intent = new Intent(StudyInfoActivity.this, DetailedInfoActivity.class);
