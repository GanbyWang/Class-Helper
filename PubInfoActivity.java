...
public class PubInfoActivity extends AppCompatActivity {
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            // System.out.println("PubInfoActivity: " + msg.obj.toString());
            ...
            switch (msg.what) {
                case HttpGet.GET_SUCC:
                    try {
                        ...
                        if (adapter == null) {
                            adapter = new MyAdapter(PubInfoActivity.this);
                        ...
                        e.printStackTrace();
                        System.out.println("PubInfoActivity: JSON WRONG!!");
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public void showInfo(int position) {
            ...
            Intent intent = new Intent(PubInfoActivity.this, DetailedInfoActivity.class);
